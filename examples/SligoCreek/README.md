...
To process the bundled estimate as comparison evidence, import it as the documented watershed reference after confirming that the modeled outlet lies inside the outline:
