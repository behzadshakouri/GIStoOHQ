...
Temporal QC reports declare policy version `temporal-qc-v3`. Published harmonized
...
Policy v3 accepts the native hourly NASA POWER labels observed from the provider:
